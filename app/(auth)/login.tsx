...
// Đã xóa bớt các Import thừa (TextInput, Eye, EyeOff, Alert) vì đã có CustomInput và useAuthForm lo
import { Activity, Sparkles, Mail, Lock, User as UserIcon } from 'lucide-react-native';
import { SafeAreaView } from 'react-native-safe-area-context';

// Import Hook xử lý Logic và Component giao diện
import { useAuthForm } from '@/src/hooks/useAuthForm';
import CustomInput from '@/src/components/CustomInput';

export default function LoginScreen() {
  // Lấy toàn bộ biến và hàm từ Hook ra để dùng
  // Lưu ý: Đã bỏ showPassword và togglePassword ở đây vì CustomInput tự quản lý nó!
  const {
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} bounces={false} showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-1 justify-end">
          <View className="bg-[#1e293b] w-full rounded-t-[32px] p-6 pb-10 border-t border-slate-700/50 shadow-2xl">
            ...
            {/* CÁC Ô NHẬP LIỆU (INPUT FIELDS)
                Đã được rút gọn tối đa nhờ CustomInput 
            */}
            ...
            <CustomInput
              ...
              icon={Lock}
              placeholder="••••••••"
              isPassword={true} // Chỉ cần truyền dòng này, logic con mắt sẽ tự hoạt động!
